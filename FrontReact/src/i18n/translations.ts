...
export const translations = {
  ...
  profile: {
    ...
    communityRatingsTitle: 'Оценка сервиса',
    communityRatingsSubtitle: 'Средняя оценка по отзывам пользователей',
    totalRatingsLabel: 'Всего оценок',
    recentReviewsTitle: 'Последние отзывы',
    noServiceRatingsYet: 'Пока нет оценок — станьте первым',
    noCommentsInReview: 'Без комментария',
  ...
  statistics: {
    ...
    nextBillToday: 'Сегодня',
    nextBillTomorrow: 'Завтра',
    nextBillDaysLeftCaption: 'до оплаты',
    nextBillOverdue: 'Просрочено',
